...
impl Palette {
    ...
    fn from_custom(custom: &CustomPalette) -> Self {
        ...
        Palette {
            background_color: parse_color(&custom.background, fallback.background_color),
            label_color: parse_color(&custom.label, fallback.label_color),
            secondary_label_color: parse_color(
                &custom.secondary_label,
                fallback.secondary_label_color,
            ),
            muted_label_color: parse_color(&custom.muted_label, fallback.muted_label_color),
            stroke_color: parse_color(&custom.stroke, fallback.stroke_color),
            secondary_stroke_color: parse_color(
                &custom.secondary_stroke,
            ...
            subtle_background_color: parse_color(
                &custom.subtle_background,
                fallback.subtle_background_color,
            ),
            accent_color: parse_color(&custom.accent, fallback.accent_color),
            on_accent_color: parse_color(&custom.on_accent, fallback.on_accent_color),
