...
use winapi::um::winuser::{
    ...
    MONITORINFO, MonitorFromPoint, ReleaseDC,
};
use winapi::{
    shared::{
...
impl OsHelper {
    ...
    fn to_installed_browser(
        ...
        /*if let Some(icon_path) = app_info.icon_path {
            create_icon_for_app(icon_path.as_str(), icon_path_str.as_str())
        }*/
