...
build_app_bundle() {
  ...
  mkdir -p "$target_dir/Browsers.app/Contents/Resources/lib"
  ...
  cp resources/lib/application-repository.toml "$target_dir/Browsers.app/Contents/Resources/lib/application-repository.toml"
